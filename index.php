...
<!-----------Hero_image_Accueil-------------------------------------------------------------------------------------------------->
        <section class="hero d-flex flex-column justify-content-center text-center" id="hero-home" alt="photo en hauteur de la plage et de la mer cristalline">
...
<!-----------Sélection_de_produits_avec_img_et_caractéristiques_en_card-------------------------------------------------------------------------------------------------->
        <section class="produits d-flex flex-wrap my-5 mx-auto" id="produits">
