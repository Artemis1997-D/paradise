...
?>
        ...
        <div class="liste-produit d-flex flex-row justify-content-center flex-wrap">
          <div class="produit-page-produit m-5 p-5">
            <img class="image-produit" src="asset/img_produit/isla-paloma-img2.webp" alt="Isla Paloma" >
            <h5>Isla Paloma</h5>
            <P>Panama</p>
            <p>2000 m2</p>
